...
Bike1 = Bike.create!(category: "VTT", description: "whatever", address: "Paris 12", daily_price: 8, user: user1)
...
Bike2 = Bike.create!(category: "Road bike", description: "this", address: "Paris 12", daily_price: 8, user: user1)
...
Bike3 = Bike.create!(category: "Mountain bike", description: "that", address: "Paris 12", daily_price: 12, user: user1)
...
Bike4 = Bike.create!(category: "Electric bike", description: "wgat", address: "Paris 12", daily_price: 8, user: user3)
...
Bike5 = Bike.create!(category: "Electric bike", description: "last", address: "Paris 12", daily_price: 10, user: user4)
